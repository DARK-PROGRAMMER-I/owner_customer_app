...
class _NewRequestViewState extends State<NewRequestView> {
  ...
  List<bool> selections = <bool>[true, false];
                            ...
                            Theme(
                              ...
                              child: TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  hintText:
                                      'Add an item...(example - Milk - 500ml)',
  ...
  navigateAndGetCategory() async {
    ...
    setState(() {
      request.category = _category.toString();
    });
  }
  ...
  String checkIfValidInputsAndGetErrMessages() {
    ...
    if (request.type == Request.LIST &&
        (request.itemArray == null || request.itemArray!.isEmpty)) {
      message += 'Please add atleast one item in the list';
    } else if (request.type == Request.PARAGRAPH &&
        (request.itemParagraph == null || request.itemParagraph!.isEmpty)) {
  ...
  saveRequest() {
    ...
    if (messages == null || messages.isEmpty) {
      Navigator.pushNamed(context, NewRequestSecondView.routeName,
  ...
  void validateAndAddItemToRequest(String newItem) {
    ...
    if (newItem.isEmpty) {
      ...
      Global.showToastMessage(
          context: context, msg: "Posting contact information is not allowed");
    } else {
