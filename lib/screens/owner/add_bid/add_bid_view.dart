...
class _AddBidViewState extends State<AddBidView> {
  ...
  Widget build(BuildContext context) {
    final AddBidViewArguments args = ModalRoute.of(context)!.settings.arguments as AddBidViewArguments;
              ...
              Expanded(
                child: DropdownButtonFormField(
                  items: ["Home Delivery", "Store Pickup"]
                      ...
                      .toList(),
                  onChanged: (option) {
                    if (option == "Home Delivery") this.type = "home_delivery";
                    if (option == "Store Pickup") this.type = "store_pickup";
                  },
                  isDense: true,
                  // onChanged: onPicked,
                  iconSize: 0,
  ...
  void addBid() async {
    if (valid()) {
      ...
      bid.type = type;
      bid.ownerId = SessionController.getOwnerInfoFromLocal().ownerId??"";
      bid.request = request;
