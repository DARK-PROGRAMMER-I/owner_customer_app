...
class _OwnerNearByViewState extends State<OwnerNearByView>
 ...
 late String category;
  ...
  late Owner owner;
  late flutterLoc.LocationData ownerLocation;
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    List<Request> requests = snapshot.data
                        !.map((e) => Request.fromJson(e.data as Map<String,dynamic>))
                        .toList()
    ...
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return GestureDetector(
            onTap: () {
             // String phone = snapshot.data?.docs[0]['phoneNumber'];
              launch("tel://3365510653");
            },
            child: Container(
              color: const Color(0xff66FD96),
