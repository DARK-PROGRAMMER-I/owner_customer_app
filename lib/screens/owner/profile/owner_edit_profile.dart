...
class _OwnerEditProfileState extends State<OwnerEditProfile> {
 late Owner owner;
  ...
  navigateAndGetCategory() async {
    ...
    setState(() {
      owner.category = _category.toString();
    });
  }
  ...
  void initState() {
    ...
    phoneNumberController.text = owner.phoneNumber.toString();
    super.initState();
  }
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      width: 60,
                      child: const Icon(Icons.smartphone, size: 35),
                    ),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          const Text("Business Category", style: TextStyle(fontWeight: FontWeight.w600)),
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Text(owner.category??"", style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600)),
    ...
    if (hasDataChanged()) {
      if (hasPhoneNumberChanged()) {
        await showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                title: const Text("Do you want to change your mobile number?"),
                content: const Text(
                ...
                actions: <Widget>[
                  ...
                  FlatButton(
                    ...
                    onPressed: () {
                      Owner localOwner = SessionController.getOwnerInfoFromLocal();
                      phoneNumberController.text = localOwner.phoneNumber.toString();
