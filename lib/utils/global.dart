...
class Global {
  ...
  static void showToastMessage(
      {context = BuildContext, msg = String}) {
    BotToast.showText(text: msg);
  }

  static const String dateTimeFormat = "MM-dd-yyyy HH:mm:ss";
...
Color kCreditColor = const Color(0xff1F853C);
...
Color kGreenColor = const Color(0xff18d29f);

const Color kDefaultColorSlab = Color(0xffffdbda);
List<Color> kColorSlabs = [
  const Color(0xffffdbda),
  const Color(0xffffc49b),
  const Color(0xff7bfeb8),
  const Color(0xffcfffb0),
